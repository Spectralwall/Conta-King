...
public class No_re_di_cuori extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_no_re_di_cuori, container, false);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //cambio fragment
                NavHostFragment.findNavController(No_re_di_cuori.this)
                        .navigate(R.id.action_navigation_no_re_di_cuori_to_navigation_no_cuori);
            }
        });
